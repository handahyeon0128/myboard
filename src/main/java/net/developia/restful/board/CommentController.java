...
public class CommentController {
	...
	@GetMapping("/")
	@ResponseBody
	public List<CommentVO> comment_list(@ModelAttribute CommentVO commentVO) throws Exception {
	...
	@PostMapping("/{com_no}")
	@ResponseBody
	public List<CommentVO> comment_update (
			@ModelAttribute CommentVO commentVO, 
			HttpServletRequest request,
	...
	@ResponseBody
	public List<CommentVO> comment_delete(
			@ModelAttribute CommentVO commentVO, 
			HttpServletRequest request,
			HttpSession session) throws Exception {
		commentVO.setCom_ip(request.getRemoteAddr());
